...
export default function CardView({ card, isOverlay, dragListeners, dragAttributes }: CardViewProps) {
  ...
  return (
    <div
      className={`
      group relative flex items-center justify-start w-full rounded-lg p-2 pl-0 select-none
    ...
    >
      ...
      <div className="pl-2 min-w-0 flex gap-2 items-center pr-6">
        ...
        <div className="w-full">
          <h4
            className={`font-medium  dark:text-zinc-100 transition-all ${card.is_completed ? "line-through text-zinc-500 italic" : "text-zinc-800"}`}
          >
            {card.title}
          </h4>
      ...
      <div
        ...
        onPointerDown={(e) => e.stopPropagation()} // bloquea dnd-kit explícitamente
      >
