...
import { addChecklistItem, deleteChecklist, deleteChecklistItem, toggleChecklistItem, updateChecklistItem } from "@/store/features/boards/ChecklistThunks";

export const CardChecklist = ({ checklist, cardId }: { checklist: Checklist; cardId: string }) => {
          ...
          <div key={item.id} className="flex items-center gap-2 group py-1">
            ...
            {editingItemId === item.id ? (
              ...
              <div className="flex items-center justify-between flex-1">
                <span
                  className={`text-sm cursor-pointer ${item.is_completed ? "line-through text-zinc-400" : "text-zinc-700"}`}
                  onClick={() => {
                ...
                <Button
                  ...
                  onPress={() => dispatch(deleteChecklistItem({
                    itemId: item.id,
                    checklistId: checklist.id,
                    cardId,
                  }))}
