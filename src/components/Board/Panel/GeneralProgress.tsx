...
export default function GeneralProgress({completed, total, overdue, dueSoon, rate}: {completed: number, total: number, overdue: Card[], dueSoon: Card[], rate: number}) {
  return (
    <div className="lg:col-span-2 bg-content1 rounded-2xl p-5 shadow-small flex flex-col gap-3">
      ...
      <Progress value={rate} color="secondary" size="md" showValueLabel label={`${rate}%`} />
