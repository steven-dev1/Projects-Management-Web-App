...
export default function UpcomingCards({
  ...
  onOpen: () => void;
  labelStats: { label: Label; count: number }[];
}) {
  return (
    <div
      className={`col-span-1 md:col-span-2 ${labelStats.length > 0 ? "lg:col-span-3" : "lg:col-span-2"} bg-content1 rounded-2xl p-5 shadow-small flex flex-col gap-2`}
    >
